...
function _s_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Header Space', '_s' ),
		'id'            => 'header-space',
		'description'   => 'Header widget space',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Space', '_s' ),
		'id'            => 'footer-space',
		'description'   => 'Footer widget space',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	...
	register_sidebar( array(
		'name'          => __( 'Partner Directory', '_s' ),
		'id'            => 'vcsassist_partner_directory',
		'description'   => 'VCS Assist Partner Directory sidebar',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
