<?php
/*
Plugin Name: List Category Posts - Template "VCS Assist Home Page"
...
// Show category link:
$lcp_display_output .= $this->get_category_link('h1', 'category-title');
...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  $lcp_display_output .= "<li class='cat-post-item'>";

  //Show the title and link to the post:
  $lcp_display_output .= $this->get_post_title($single, 'h4', 'post-title');


  //Show date:
  $lcp_display_output .= '<p class="post-date">' . $this->get_date($single) . '</p>';
  ...
  // Get Posts "More" link:
  // $lcp_display_output .= 'helowrld' . $this->get_posts_morelink($single);
